...
**Date in the room:** Thursday, October 30, 2025, called at **6:01 p.m.** Quorum physically present at AISD central office. Broadcast Spectrum 22 / AT&T 99; English captions.  
**Source:** `meetings/clean/20251104-Austin-ISD-Board-of-Trustees-Regular-Voting-Meeting--October-302025.txt`  
**This is the vote night.** Closures / TAP are **not** on this agenda. They remain November 20.
...
- Belinda Montgomery, Sharon Bain, Richard Kelly (24th-year teacher), Amy Garrett: yes on **10.1** (Prop A already allowed it).
- “Marie Parent”: 5.1 closures — more time; 5.3 HQ spending / legal / lawsuits; 6.1 Mendez numbers, don’t renew Third Future; 10.1 not Grammarc; 10.2 cut HQ; 12.1 insufficient data in BoardDocs.
- Patrick Rosenthal: **8.1** accept Anderson IB statement; schools on the closure list still deserve options.
- Greg Foley: 2019 Segura came from AECOM (facility report used to close schools); now Steady State Impact and TNTP “up to $20 million”; release the contracts.
- “Guawa Gera”: parent of three, two at a 3UA campus. Lone Star Governance minutes: do TAP discussions count toward student-outcome time? Ask the monitor tonight.
- Adam Sparks: three weeks from final TAP/consolidation vote; **no campus-level savings** yet, promised before October 3. Trustees had said they would not vote yes without 2019 financials. Put measurables in the plan.
...
- Linder — modernization nearly complete; growth; extra staffing.
- Walnut Creek (“Waldridge”) — Domain 3 growth 30 → 62 (2023–25).
- Paredes — large; only neighborhood middle; Domain 3 30 → 73.
- Pickett Springs — outlier: no accelerated growth, but modernized; “maximum supports”; strategy not final (`00:34:03`).

**Reassign** (majority to an acceptable nearby campus; some also on the consolidation list — “intersection”):

- Barrington — 75% to Guerrero Thompson (A/B). Modernization not started; weak growth.
- Bedichek — 58% to Covington (C); rest to Mendez and Paredes. Domain 3 57 → 59 (2023–25); not enough growth for restart.
- Dawson — 100% to Galindo. ~150 students campuswide; small n on STAAR.
- Oak Springs — 100% to Blackshear. Community meetings with Blackshear **not yet held**; “very drafty” (`00:38:38`).
- Martin — 46% Keeling, 28% Marshall, 26% Lively. Resides could fill it; families don’t attend. Receiving campuses that take TAP students get extra staff, not only the TAP campus.
- Sanchez — Domain 3 54 → 58. 53% to Allison (three Ds / 1UA) — Allison gets heavier support.
- Winn Montessori — extra seats in that area of town. Community wants to keep Montessori; restart would require bilingual + Montessori-certified new staff they don’t believe they can hire. 69% to Rodriguez (historically B in 2024, now 69).
...
**Consent, unanimous** (`01:23:19`–`01:25:50`)  
Motion Gonzalez, second Quintana.  
**8.1, 9.1, 10.1, 10.2, 11.1 through 11.5, 12.1, 13.1 and 13.2.**  
Singh on 10.1: ~**$500,000** Prop A mental-health contract, **supplement not supplant**. Boswell: year-over-year? Segura / Maxwell: allocation may change; **intent is to keep investing** Prop A mental-health dollars.

**14.1** Lone Star Governance quarterly and annual evaluation (`01:25:58`–`01:48:16`)  
...
**Passes by all on the dais.** Annual narrative is in BoardDocs.

**14.2** issuance of tax and revenue anticipation note (`01:48:35`–`01:49:07`)  
Motion Gonzalez, second Quintana. “This is the loan that we talked about with Miss Montgomery.”  
**Passes by all on the dais.** $19 million TRAN.
